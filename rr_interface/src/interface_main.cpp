...
int main(int argc, char **argv)
{
	...
	*/
	...
	while (ros::ok())
	{
		...
		int n = write(serial_port_filestream, "w", sizeof(test));
		//ROS_INFO("Wrote 'Hello World!' to %s", serial_port_name.c_str());
		...
		// int n = read(serial_port_filestream, &read_buf, sizeof(read_buf));
